...
namespace IdentityServer4.ResponseHandling
{
    ...
    public interface IAuthorizeInteractionResponseGenerator
    {
        ...
        /// <returns></returns>
        Task<InteractionResponse> ProcessInteractionAsync(ValidatedAuthorizeRequest request, ConsentResponse consent = null, CancellationToken cancellationToken = default);
    }
}