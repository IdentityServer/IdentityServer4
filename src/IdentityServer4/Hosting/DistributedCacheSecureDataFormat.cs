...
{
    class DistributedCacheSecureDataFormat : ISecureDataFormat<AuthenticationProperties>
    {
        private readonly IHttpContextAccessor _httpContext;
        private readonly string _name;

        public DistributedCacheSecureDataFormat(IHttpContextAccessor httpContext, string name)
        {
            _httpContext = httpContext;
            _name = name;
        }

        string CacheKeyPrefix => "DistributedCacheSecureDataFormat";
