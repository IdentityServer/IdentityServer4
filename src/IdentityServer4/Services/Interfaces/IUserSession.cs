...
namespace IdentityServer4.Services
{
    ...
    internal class CookieAuthenticationUserSession : IUserSession
    {
        const string SessionIdKey = "session_id";
        const string ClientListKey = "client_list";
        ...
        public CookieAuthenticationUserSession(
            IHttpContextAccessor httpContextAccessor, 
            IdentityServerOptions options,
            ILogger<CookieAuthenticationUserSession> logger)
        {
