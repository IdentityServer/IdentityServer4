...
* most external providers only support a fixed set of claims and claim types - having a gateway in the middle allows to post-process the response from the providers to transform/add/ammend domain specific identity information
